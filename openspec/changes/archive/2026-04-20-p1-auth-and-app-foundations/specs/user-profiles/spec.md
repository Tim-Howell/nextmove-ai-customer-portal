...
The system SHALL require customer_user profiles to have a customer_id linking them to their customer account.

#### Scenario: Customer user has customer_id
- **WHEN** a user has role "customer_user"
- **THEN** their profile has a non-null customer_id
