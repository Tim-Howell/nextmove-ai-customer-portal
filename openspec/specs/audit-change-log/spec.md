# audit-change-log Specification

## Purpose
Defines where and how change/audit history is surfaced in the UI. The Change Log page is the single source of truth for audit history; item detail pages do not show inline history.
