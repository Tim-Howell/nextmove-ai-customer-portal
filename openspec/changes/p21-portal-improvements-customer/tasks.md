...
- [ ] 7.1 Test contract list displays correct summaries for each type
- [ ] 7.2 Test health indicators appear at correct thresholds
- [ ] 7.3 Test staff names appear on time entries and reports
- [ ] 7.4 Test submitter names appear on requests
- [ ] 7.5 Test CSV export includes headers and staff column
- [ ] 7.6 Test access denied toast appears for internal routes
- [ ] 7.7 Final review of customer portal UX improvements
